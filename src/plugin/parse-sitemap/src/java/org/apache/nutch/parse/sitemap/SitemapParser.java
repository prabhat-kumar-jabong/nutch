...
public class SitemapParser implements org.apache.nutch.parse.Parser {
  ...
  public Parse getParse(String url, WebPage page) {
    ...
    if (!metaTags.getNoFollow()) { // okay to follow links
     ...
     // utils.getOutlinks(baseTag != null ? baseTag : base, l, root);
      try {
    	String linkTokens[] = text.split(" ");
    	for(String token:linkTokens){
    		l.add(new Outlink(token,"href"));
    	}
	} catch (MalformedURLException e) {
		throw new RuntimeException("Not a proper url after parsing for sitemap.",e);
	}
