...
//    	  
//    	  String strContent = new String(b,charSet);
//    	  System.out.println(strContent);
//    	  content = get.getResponseBody();//strContent.getBytes();
//      }catch(Exception e){
//    	  if(code == 200)
//    		  throw new IOException(e.toString()); 
//      }finally{
...
//      }
  ...
  public byte[] getResponseBody(HttpMethod method) throws IOException{
	  ...
	  if ("gzip".equals(contentEncoding) || "x-gzip".equals(contentEncoding)) {
		  ...
		  StringWriter responseBody = new StringWriter();
	      PrintWriter responseWriter = new PrintWriter(responseBody);
	      DeflaterInputStream zippedInputStream =  new DeflaterInputStream(method.getResponseBodyAsStream());
	        BufferedReader r = new BufferedReader(new InputStreamReader(zippedInputStream));
	        String line = null;
	          while( (line =r.readLine()) != null){
	            responseWriter.println(line);
